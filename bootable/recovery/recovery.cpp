...
//20150304 xiexijun add advancereset flag to nvram ,which is a factory request begin.
int reset_property_set(void)
{
  ensure_path_mounted("/data");
  property_set("recovery.prop", "1");
  sleep(1);
  property_set("persist.sys.reset.flag", "1");
   
	return 1;
}
//20150304 xiexijun add advancereset flag to nvram ,which is a factory request end.
...
//adupsfota end
    switch (after) {
        ...
        default:
            ui->Print("Rebooting...\n");
            reset_property_set();//20150304 xiexijun add advancereset flag to nvram ,which is a factory request

...
void fan5405_turn_on_charging(kal_uint32 bEnable)
{
 if(KAL_TRUE == bEnable)
 	{
   ...
   mt_set_gpio_out(gpio_number,gpio_off_out);	
      ...
      fan5405_reg_config_interface(0x06,0x7f); //set ISAFE//0x10//0x57		
	...
	fan5405_reg_config_interface(0x04,0x72); //set IOCHARGE 1000MA
...
mt_set_gpio_mode(gpio_number,gpio_on_mode);  
    ...
    printf("[fan5405_hw_init] lk H(0x06,0x7f)\n");
    fan5405_reg_config_interface(0x06,0x7f); // set ISAFE and HW CV point (4.44)
    fan5405_reg_config_interface(0x02,0xba); // 4.42 //VOREG
#else
    printf("[fan5405_hw_init] lk L(0x06,0x70)\n");
    fan5405_reg_config_interface(0x06,0x7f); // set ISAFE
    fan5405_reg_config_interface(0x02,0xba); // 4.2
#endif    

...
#ifndef FUNCTIONFS_SS_DESC_MAGIC
...
static const struct {
    ...
    struct {
        __le32 ss_magic;
        __le32 ss_count;
    } __attribute__((packed)) ss_header;
    struct {
        struct usb_interface_descriptor intf;
        struct usb_endpoint_descriptor_no_audio sink;
        struct usb_ss_ep_comp_descriptor comp_sink;
        struct usb_endpoint_descriptor_no_audio source;
        struct usb_ss_ep_comp_descriptor comp_source;
    ...
    .ss_header = {
        .ss_magic = cpu_to_le32(FUNCTIONFS_SS_DESC_MAGIC),
        .ss_count = 5,
    },
    .ss_descs = {
        .intf = {
        ...
        .comp_sink = {
            .bLength = sizeof(descriptors.ss_descs.comp_sink),
        ...
        .comp_source = {
            .bLength = sizeof(descriptors.ss_descs.comp_source),
            .bDescriptorType = USB_DT_SS_ENDPOINT_COMP,
            .bMaxBurst = 0,
            .bmAttributes = 0,
            .wBytesPerInterval = 0,

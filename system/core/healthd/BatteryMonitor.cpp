    ...
    if (logthis) {
        ...
        if (props.batteryPresent) {
            snprintf(dmesgline, sizeof(dmesgline),
                 "battery p=%d l=%d l2=%d v=%d t=%s%d.%d h=%d st=%d st2=%d ext=%d",
                 props.adjustPower, props.batteryLevel, props.batteryLevel_smb, 
                 props.batteryVoltage,
                 props.batteryTemperature < 0 ? "-" : "",
                 abs(props.batteryTemperature / 10),
                 abs(props.batteryTemperature % 10), 
                 props.batteryHealth,
                 props.batteryStatus, props.batteryStatus_smb,

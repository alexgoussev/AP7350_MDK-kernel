...
public:
    ...
    void setBroadcaster(SocketListener *sl) { mBroadcaster = (CommandListener*)sl; }
    CommandListener *getBroadcaster() { return mBroadcaster; }
    ...
    void swap2Sdcard();
    bool is2SdcardSwapped();
    void setNeedSwapAfterUnmount(bool value);
    bool getNeedSwapAfterUnmount(void);
    void setNeedSwapAfterMount(bool value);
    bool getNeedSwapAfterMount(void);

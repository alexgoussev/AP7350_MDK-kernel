/*
 * include/media/se4750.h
 *
 * SE4750 sensor driver
 *
...
#define USE_SE4750	// Comment this out to revert back to the MT9T111 reference code

#define SE4750_MODULE_NAME			"se4750"		// Name of this module
#define SE4750_MISC_NAME			"moto_sdl"		// Name used to register as 'misc' device

#define SE4750_I2C_ADDR				0x5C

#define SE4750_CLK_MAX				96000000	// 96MHz
#define SE4750_CLK_MIN				6000000		// 6Mhz

#define SE4750_I2C_CONFIG			1

#define SE4750_SENSOR_WIDTH			1360
#define SE4750_SENSOR_HEIGHT		960
...
// SE4750 command status values
#define SE45STS_ACK					0x80

// SE45OP_RESET modifiers
#define RESET_SENSOR				0
#define RESET_SE4750				1

// SE4750 Parameter ID's

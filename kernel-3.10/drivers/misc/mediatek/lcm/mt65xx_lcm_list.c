...
extern LCM_DRIVER otm8018b_dsi_vdo_xind_lcm_drv;
...
extern LCM_DRIVER hx8394f_hd720_dsi_vdo_chaosheng_lcm_drv;
...
extern LCM_DRIVER ili9881c_hd_dsi_vdo_hlt_lcm_drv;
extern LCM_DRIVER ili9881c_hd_dsi_vdo_djn_lcm_drv;
extern LCM_DRIVER ili9488_dsi_hvga_lcm_drv;
...
#if defined(OTM8018B_DSI_VDO_XIND)
    &otm8018b_dsi_vdo_xind_lcm_drv,
#endif
...
#if defined(HX8394F_HD720_DSI_VDO_CHAOSHENG)
	&hx8394f_hd720_dsi_vdo_chaosheng_lcm_drv,
#endif
...
#if defined(ILI9881C_HD_DSI_VDO_HLT)
    &ili9881c_hd_dsi_vdo_hlt_lcm_drv,
#endif

#if defined(ILI9881C_HD_DSI_VDO_DJN)
    &ili9881c_hd_dsi_vdo_djn_lcm_drv,
#endif

#if defined(ILI9488_DSI_HVGA)
    &ili9488_dsi_hvga_lcm_drv,
#endif
};

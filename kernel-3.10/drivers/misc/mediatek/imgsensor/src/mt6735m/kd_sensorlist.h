...
//CY use OV8858_MIPI_RAW_SensorInit
...
UINT32 S5K5E2YAQT_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); //add for qt
...
{
#if defined(GC2355_2L_MIPI_RAW)
    {GC2355_2L_SENSOR_ID, SENSOR_DRVNAME_GC2355_2L_MIPI_RAW,GC2355_2L_MIPI_RAW_SensorInit},
#endif
#if defined(OV2680_2L_MIPI_RAW)
    {OV2680_2L_MIPI_SENSOR_ID, SENSOR_DRVNAME_OV2680_2L_MIPI_RAW,OV2680_2L_MIPISensorInit},
#endif
#if defined(HI551_2L_MIPI_RAW)
    {HI551_2L_SENSOR_ID, SENSOR_DRVNAME_HI551_2L_MIPI_RAW,HI551_2L_MIPI_RAW_SensorInit},
#endif
/*IMX*/
...
#endif
//add by hhk 2015-6-25
#if defined(OV8858QT_MIPI_RAW)
    {OV8858QT_SENSOR_ID, SENSOR_DRVNAME_OV8858QT_MIPI_RAW,OV8858QT_MIPI_RAW_SensorInit},
#endif
//end 
...
/*S5K*/
    ...
    {S5K3H7YX_SENSOR_ID, SENSOR_DRVNAME_S5K3H7YX_MIPI_RAW, S5K3H7Y_MIPI_RAW_SensorInit},
#endif
...
#endif
//ADD FOR QT
#if defined(S5K5E2YAQT_MIPI_RAW)
    {S5K5E2YAQT_SENSOR_ID, SENSOR_DRVNAME_S5K5E2YAQT_MIPI_RAW, S5K5E2YAQT_MIPI_RAW_SensorInit},
#endif
//end

...
u32 pinSet[3][8] = {
	...
	if(currSensorName && ((0 == strcmp(SENSOR_DRVNAME_OV8858_MIPI_RAW,currSensorName))||(0 == strcmp(SENSOR_DRVNAME_OV8858QT_MIPI_RAW,currSensorName))||(0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW,currSensorName))||(0 == strcmp(SENSOR_DRVNAME_S5K5E2YA_MIPI_RAW,currSensorName))||(0 == strcmp(SENSOR_DRVNAME_S5K5E2YAQT_MIPI_RAW,currSensorName))))
		{
    ...
    else if (currSensorName &&((0 == strcmp(SENSOR_DRVNAME_HI551_MIPI_RAW, currSensorName))||(0 == strcmp(SENSOR_DRVNAME_HI551_2L_MIPI_RAW, currSensorName))))
	{
		//HI545 Power UP
		PK_DBG("=======================HI551==========================\n");
		if(TRUE != hwPowerOn(CAMERA_POWER_VCAM_IO, VOL_1800, mode_name))
 ...
 //end
   //add by hhk for gc2355 ov2680
	else if ((currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV2680_MIPI_RAW, currSensorName)))||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV2680_2L_MIPI_RAW, currSensorName))))
	{
				PK_DBG("kdCISModulePowerOn get in--- %s \n",currSensorName);
				//PK_DBG("[ON_general 2.8V]sensorIdx:%d \n",SensorIdx);
				if(TRUE != hwPowerOn(CAMERA_POWER_VCAM_IO, VOL_1800,mode_name))
	...
	else if ((currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC2355_MIPI_RAW, currSensorName)))||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC2355_2L_MIPI_RAW, currSensorName))))
	{
				PK_DBG("kdCISModulePowerOn get in--- %s \n",currSensorName);
				//PK_DBG("[ON_general 2.8V]sensorIdx:%d \n",SensorIdx);
				if(TRUE != hwPowerOn(CAMERA_POWER_VCAM_IO, VOL_1800,mode_name))
...
#endif
		if(currSensorName && ((0 == strcmp(SENSOR_DRVNAME_OV8858_MIPI_RAW,currSensorName))||(0 == strcmp(SENSOR_DRVNAME_OV8858QT_MIPI_RAW,currSensorName))))
		//if(0)
		{
...
//add by  hhk for sp2508 2015-9-10
	  else if(currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP2508_MIPI_RAW,currSensorName)))
	  {
		  PK_DBG("kdCISModulePower--off get in---%s \n",currSensorName);
...
//end	  
	  ...
	  else if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_HI551_2L_MIPI_RAW, currSensorName)))
	  {
	     if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST]) {
            if(mt_set_gpio_mode(pinSet[pinSetIdx][IDX_PS_CMRST],pinSet[pinSetIdx][IDX_PS_CMRST+IDX_PS_MODE])){PK_DBG("[CAMERA SENSOR] set gpio mode failed!! \n");}
            if(mt_set_gpio_mode(pinSet[pinSetIdx][IDX_PS_CMPDN],pinSet[pinSetIdx][IDX_PS_CMPDN+IDX_PS_MODE])){PK_DBG("[CAMERA LENS] set gpio mode failed!! \n");}
    	...
    	if(TRUE != hwPowerDown(CAMERA_POWER_VCAM_A,mode_name)) {
            PK_DBG("[CAMERA SENSOR] HI551 Fail to OFF VCAM_A\n");
            //return -EIO;
            //goto _kdCISModulePowerOn_exit_;
        }
        if(TRUE != hwPowerDown(CAMERA_POWER_VCAM_AF,mode_name))
        {
            PK_DBG("[CAMERA SENSOR] HI551 Fail to OFF VCAM_A2 \n");
            //return -EIO;
            //goto _kdCISModulePowerOn_exit_;
        }
        if(TRUE != hwPowerDown(CAMERA_POWER_VCAM_D, mode_name)) {
            PK_DBG("[CAMERA SENSOR] HI551 Fail to OFF VCAM_D\n");
            //return -EIO;
            //goto _kdCISModulePowerOn_exit_;
        }
        if(TRUE != hwPowerDown(CAMERA_POWER_VCAM_IO,mode_name))
        {
            PK_DBG("[CAMERA SENSOR] HI551 Fail to OFF VCAM_D2 \n");
            //return -EIO;
            goto _kdCISModulePowerOn_exit_;
        }
    }//

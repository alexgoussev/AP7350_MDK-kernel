...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	{0xA1,0x01,{0x1F}},               //VP251
	{0xA2,0x01,{0x2D}},               //VP247
	{0xA3,0x01,{0x12}},               //VP243
	{0xA4,0x01,{0x16}},               //VP239
	{0xA5,0x01,{0x2A}},               //VP231
	{0xA6,0x01,{0x1e}},               //VP219
	{0xA7,0x01,{0x1f}},               //VP203
	{0xA8,0x01,{0x8A}},               //VP175
	...
	{0xC1,0x01,{0x1F}},               //VN251
	{0xC2,0x01,{0x2D}},               //VN247
	{0xC3,0x01,{0x12}},               //VN243
	{0xC4,0x01,{0x16}},               //VN239
	{0xC5,0x01,{0x2A}},               //VN231
	{0xC6,0x01,{0x1E}},               //VN219
	{0xC7,0x01,{0x1f}},               //VN203
	{0xC8,0x01,{0x8A}},               //VN175
...
static unsigned int lcm_compare_id(void)
{
	...
	array[0]=0x00063902;
	array[1]=0x0698FFFF; //enable CMD2
	array[2]=0x00000104;
...
#if defined(BUILD_LK)
	printf("ili9806e id = 0x%02x,buf[2] = 0x%02x\n", id, buffer[2]);
#else
	printk("ili9806e id = 0x%02x,buf[2] = 0x%02x\n", id, buffer[2]);
#endif
	...
	if((id == LCM_ID) && ( 0x04 == buffer[2]))
	{
		...
		IMM_GetOneChannelValue(1,adcdata,&rawdata);
		rawdata = rawdata * 1500/4096;
		#if defined(BUILD_LK)
		printf("ili9806e txd_fwvga channelValue=%d\n",rawdata);
		#else
		printk("ili9806e txd_fwvga channelValue=%d\n",rawdata);
		#endif
#endif
			return 1;
	}

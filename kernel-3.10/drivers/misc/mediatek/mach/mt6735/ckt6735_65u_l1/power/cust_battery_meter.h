...
#if defined(CONFIG_CKT_NOVA02A_BATTERY)
#include "ckt_cust_battery_meter.h"  //added by sen.luo 20150818
#elif defined(CONFIG_CKT_NOVA03A_BATTERY)
#include "ckt_nova03a_cust_battery_meter.h"  //added by sen.luo 20150922
#else
/* Qmax for battery  */
#define Q_MAX_POS_50	3000
#define Q_MAX_POS_25	3000
#define Q_MAX_POS_0		3000
#define Q_MAX_NEG_10	3000

#define Q_MAX_POS_50_H_CURRENT	3000
#define Q_MAX_POS_25_H_CURRENT	3000
#define Q_MAX_POS_0_H_CURRENT	  3000
#define Q_MAX_NEG_10_H_CURRENT	3000

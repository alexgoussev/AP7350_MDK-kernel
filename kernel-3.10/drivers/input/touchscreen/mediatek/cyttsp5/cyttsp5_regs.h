...
/*add for download start*/
#define CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP5_BINARY_FW_UPGRADE 1		/*upadte bin file */
#define CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP5_PLATFORM_TTCONFIG_UPGRADE 1	/*upadte headfile */
/*add for downaload end*/
#define CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP5_TARGET_MEDIATEK 1
#ifdef CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP5_TARGET_MEDIATEK
#define CYTTSP5_IRQ_NO_GPIO
#define CYTTSP5_I2C_DMA
#define CYTTSP5_NO_PM_RUNTIME
#define FTS_DMA_BUF_SIZE	4096
#undef NEED_SUSPEND_NOTIFIER
#endif
...
static inline void cyttsp5_request_resume(struct device *dev)
{
...
static inline void cyttsp5_request_suspend(struct device *dev)
{
#ifndef CYTTSP5_NO_PM_RUNTIME
	pm_runtime_put(dev);
#endif

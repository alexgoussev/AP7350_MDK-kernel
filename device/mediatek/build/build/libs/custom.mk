...
$(foreach t,$(CKT_AUTO_ADD_GLOBAL_DEFINE_BY_NAME_VALUE),$(call .if-cfg-on,$(t),$(foreach v, $($(t)),-D$(call uc,$(t))=$(v)))))
endef
...
MTK_PROJECT_CONFIGS += $(addsuffix /ProjectConfig_ckt.mk,$(MTK_CUSTOM_PATH))
